...
class CityMultiSelectPage extends StatefulWidget {
  @override
  _CitySelectPageState createState() => _CitySelectPageState();
}

class _CitySelectPageState extends State<CityMultiSelectPage> {
  ...
  Future<void> _loadData() async {
    ...
    if (Constant.isDriverTest) {
      jsonStr = await _loadString('assets/data/cityMap.json');
    } else {
      jsonStr = await rootBundle.loadString('assets/data/cityMap.json');
    }
